...
REPO_NAME='speakeasy-clone'
REPO_SLUG='speakeasy-clone'
DEFAULT_BRANCH='main'
GITHUB_URL='https://github.com/rodgemd1-lgtm/speakeasy-clone'
GITHUB_RAW_BASE='https://github.com/rodgemd1-lgtm/speakeasy-clone/raw/main'
QNAP_CLONE='ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/speakeasy-clone.git'
