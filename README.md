...
![status](https://img.shields.io/badge/status-consolidation-candidate-blue) ![lane](https://img.shields.io/badge/lane-client-work-purple) ![visibility](https://img.shields.io/badge/visibility-public-lightgrey) ![qnap](https://img.shields.io/badge/qnap-qnap-verified-green) ![proof](https://img.shields.io/badge/proof-required-red)

## 30-Second Pitch

Static mirror of speakeasybarberlounge.com Evidence from the tracked tree: Vercel deployment.

## Live State

| Field | Value |
| --- | --- |
| GitHub | https://github.com/rodgemd1-lgtm/speakeasy-clone |
| QNAP canonical/mirror | `ssh://git@nas94f2ae.tail4d96b3.ts.net:2222/rig/speakeasy-clone.git` |
| Lane | `client-work` - client delivery workspaces |
| Visibility | `public` |
| Primary language | `HTML` |
| Last pushed | `2026-04-29T05:43:22Z` |
| QNAP status | `imported_to_qnap_gitea` |
| QNAP HEAD | `0261cdb59a41` |
| Consolidation action | `archive-after-asset-harvest` |
...
- Repo deep dive: [speakeasy-clone](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-deep-dives/speakeasy-clone.md)
...
9 data/config/knowledge-like files; 1 docs/notes; 116 media/design assets; 2 sensitive-path-name matches.
...
171 tracked files across 5 directories. Code files: 43. Test files: 0. 9 data/config/knowledge-like files; 1 docs/notes; 116 media/design assets; 2 sensitive-path-name matches.

Aggregate GitHub tree size: `13.1 MB` across `171` blobs.
...
| --- | ---: | ---: |
| `images` | 8.4 MB | 51 |
| `images-local` | 2.6 MB | 66 |
| `css` | 1.1 MB | 27 |
| `.` | 611.6 KB | 12 |
| `fonts` | 334.1 KB | 2 |
| `.designlang` | 84.5 KB | 13 |
...
Full public inventory: [speakeasy-clone.txt](https://github.com/rodgemd1-lgtm/Startup-Intelligence-OS/blob/claude/rig-sovereign-audit-mesh/docs/repositories/repo-file-inventories/speakeasy-clone.txt)
...
- V6: Consolidation action is resolved: `archive-after-asset-harvest`.
...
- Harvest reusable snippets, docs, and assets into the canonical target.
- Record the archive decision and keep the recovery branch/bundle discoverable.
